                ...
                <table class="table table-striped table-bordered table-hover" id="tabla-data">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>{{$data->nombre}}</td>
                            <td>{{$data->email}}</td>
                            <td>{{$data->numTelefono}}</td>
                            <td>{{$data->credito_limite}}</td>
                            <td>
                            ...
                            <td>
                                ...
                                <form action="{{route('eliminar_usuario', ['id' => $data->id])}}" class="d-inline form-eliminar" method="POST">
                                    ...
                                    <button type="submit" class="btn-accion-tabla eliminar tooltipsC" title="Eliminar este registro">
                                        ...
                                        <a href="{{route('muestra_lista_usuario', ['id' => $data->id])}}" class="btn-accion-tabla tooltipsC" title="Mostrar Lista Precio">
